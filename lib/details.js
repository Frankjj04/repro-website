...
export function buildDetails(a, opts = {}) {
  ...
  ${box(t.where,
    ...
    (log.venue ? button(mapLink(log.venue), t.map, '#0A0E2A').replace('class="bp-btn"', 'class="bp-btn bp-btn-navy"') : ''), '#FF6B1A')}
  ${bring.length ? box(t.bring,
    `<ul class="bp-text" style="margin:0;padding-left:18px;font:400 15px/1.7 Arial,sans-serif;color:#22263A;">${
