...
const T = {
  es: {
    ...
    unavailable_p: 'Este link venció o fue desactivado. Pide uno nuevo a Be Pro Soccer.',
    ...
    contact_p: 'Todos los contactos pasan por Be Pro Soccer. Escríbenos y te conectamos con el jugador y su familia.',
    contact_btn: 'Contactar a Be Pro Soccer',
    wa_general: 'Hola Be Pro Soccer, vi los perfiles de jugadores que me compartieron y quiero más información.',
    wa_player: (name, y) => `Hola Be Pro Soccer, vi el perfil de ${name} (categoría ${y}) y me interesa. ¿Podemos hablar?`,
  ...
  en: {
    ...
    unavailable_p: 'This link has expired or was turned off. Ask Be Pro Soccer for a new one.',
    tag: 'Player profiles',
    ...
    contact_p: 'All contact goes through Be Pro Soccer. Message us and we will connect you with the player and their family.',
    contact_btn: 'Contact Be Pro Soccer',
    wa_general: 'Hi Be Pro Soccer, I saw the player profiles you shared with me and would like more information.',
    wa_player: (name, y) => `Hi Be Pro Soccer, I saw ${name}'s profile (born ${y}) and I'm interested. Can we talk?`,
